package MODELO; // Paquete que contiene las clases de acceso a datos

import MODELO.Usuario; // Importa la clase Usuario que representa la entidad de usuario
import DATABASE.ConnectionDB; // Importa la clase ConnectionDB que maneja la conexión a la base de datos
