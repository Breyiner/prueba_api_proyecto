...
public class GeneroService {
    ...
    public static Response getGeneroById(int id) {
        Genero genero = null;
        try {
    ...
    public static Response updateGenero(int id, Genero generoData) {
        try {
            Response generoExistente = getGeneroById(id);
    ...
    public static Response deleteGenero(int id) {
        try {
